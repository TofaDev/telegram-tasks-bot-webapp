...
export declare class InlineKeyboard {
    ...
    static keyboard(rows: (Interfaces.TelegramInlineKeyboardButton | Interfaces.TelegramInlineKeyboardButton[])[]): InlineKeyboard;
    ...
    static switchToCurrentChatButton(params: SwitchToCurrentChatButtonParams): Interfaces.TelegramInlineKeyboardButton;
    /** Generate button that will prompt user to select one of their chats */
    static switchToChatButton(params: SwitchToChatButtonParams): Interfaces.TelegramInlineKeyboardButton;

...
export declare class ChatAdministratorRights implements Structure {
    payload: Interfaces.TelegramChatAdministratorRights;
    constructor(payload: Interfaces.TelegramChatAdministratorRights);
